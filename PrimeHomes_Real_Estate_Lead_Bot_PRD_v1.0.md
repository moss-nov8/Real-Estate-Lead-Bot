...
### n8n — Workflow State / Orchestration
...
For the first working version, the entire vision should not be built at once.
...
One of the things to introduce from the beginning is traceability.
...
The important distinction is that this is the product direction, not yet the final System Architecture. Those decisions will be made properly in Document #2.
...
Freeze this PRD at **v1.0** after the product scope is agreed.

Individual coding agents should not redefine product requirements while implementing features. Changes should come back through the PRD/decision process.

The next document should be:

> **#2 — System Architecture Document (SAD)**

That document will define the technical architecture around:
